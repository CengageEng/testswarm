...
-- Insertions handled by the createProject.php script.
--

CREATE TABLE `projects` (
  `id` varchar(255) binary NOT NULL default '' PRIMARY KEY,

  -- Human readable display title for the front-end.
  `display_title` varchar(255) binary NOT NULL default '',
  ...
  `auth_token` binary(40) NOT NULL default '',
...
ALTER TABLE jobs
	ADD CONSTRAINT fk_jobs_project FOREIGN KEY (project_id) REFERENCES projects (id);
